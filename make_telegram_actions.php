...
$commands = [
                ...
                ['cmd' => ['отключи автоматику бака', 'выключи автоматику бака'],
                ...
                ['cmd' => ['включи насос в душ', 'включи насос в душе'],
                 'script' => 'shower_pump.php', 'args' => 'enable'],

                ['cmd' => ['отключи насос в душ', 'отключи насос в душе',
                           'выключи насос в душ', 'выключи насос в душе'],
